(function (global, factory) {
  ...
  console.log("idb-file-storage.js: constructur");
     ...
     */
    initializedDB() {
	  console.log("idb-file-storage.js: initializedDB");
    ...
    async put(fileName, file) {
	  ...
	  console.log("idb-file-storage.js: put");
	  console.log("idb-file-storage.js: put fileName=" + fileName);
	  console.log("idb-file-storage.js: put file="+file);
...
if (!fileName || typeof fileName !== "string") {
      ...
      const objectStore = this.getObjectStoreTransaction({ idb, mode: "readwrite" });
	   ...
	   console.log("idb-file-storage.js: objectStore" + objectStore);
