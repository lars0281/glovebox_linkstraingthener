...
//	console.log(linkUrl);
	...
	// calculate box width by multplying number of charcters per row by pix per character, and add something for margin
	box_widtht = (chars_per_row * 8) + 10;
	// calculate box height by multplying number of charcters per row by pix per character, and add something for margin
	box_height = (rows * 30) + 10;
	
	
	
	console.log("box_height: " + box_height );
	console.log("box_widtht: " + box_widtht );
